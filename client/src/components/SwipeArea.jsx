					...
					>
						<figure className='px-4 pt-4 h-3/4'>
							<img
								...
								alt={user.name}
								className='object-cover h-full rounded-lg pointer-events-none'
							/>
						</figure>
						<div className='card-body bg-gradient-to-b from-white to-pink-50'>
							<h2 className='text-2xl text-gray-800 card-title'>
								{user.name}, {user.age}
							</h2>
							<h2 className='text-xl text-gray-800 card-title'>
								{user.prof}
							</h2>
